package lib.snail.core.ui.custom.pulltozoomview;
...
public class PullToZoomScrollViewEx extends PullToZoomBase<ScrollView> {
    ...
    public OnPullScrollViewListener scrollListener;
    public void setOnPullScrollViewListener(OnPullScrollViewListener scrollListener){
        this.scrollListener = scrollListener;
    }
    public interface OnPullScrollViewListener{
        void scrollChange(float scrollY);
    }
        ...
        ((InternalScrollView) mRootView).setOnScrollViewChangedListener(new OnScrollViewChangedListener() {
            ...
            public void onInternalScrollChanged(int left, int top, int oldLeft, int oldTop) {
                if (isPullToZoomEnabled() && isParallax()) {
                    ...
                    scrollListener.scrollChange(mRootView.getScrollY());
