package lib.snail.core.ui.custom.indicatorview;
...
//                mIndicatorTextArray = a.getTextArray(attr);
    ...
    public void setIndicatorTextArray(List<String> sList){
        if(sList!=null &&sList.size()>0){
            mIndicatorTextArray = sList.toArray(new CharSequence[sList.size()]);
            init();
        }
